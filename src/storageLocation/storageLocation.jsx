...
import Form from './storageLocationForm'
...
class StorageLocation extends Component {
    ...
    render() {
        return (
            <div>
                <ContentHeader title='Locais de Armazenagem' small='Cadastro' />
                <Content>
                    <Tabs>
                        <TabsHeader>
...
export default connect(null, mapDispatchToProps)(StorageLocation)
